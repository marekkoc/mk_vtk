...
VesselView - soft to 3D visualization of numerica  vascular tree described in *.ves file.
...
import mklib_vtk.mklib_vtkpolydata_io as mkp
...
###
    ...
    if 1: mkp.writePolyData(fn + '.vtk', polydata)
